        ...
        "<tr>" +
            "<td>" +
                "<table>" +
                    "<tr>" +
                        "<td>" +
                            "<div id='instructions' style='width:420px'><strong>Keyboard Shortcuts</strong>" +
                                "<ul>" +
                        ...
                        "</td>" +
                        "<td>" +
                            "<div id='instructions'><strong>Joints of Interest</strong>" +
                                "<div style='margin-top: 10px'><img src='body_joint_fig.jpg' width='256'></div>" +
                            "<div>" +
                        "</td>" +
                    "</tr>" +
                "</table>" +
